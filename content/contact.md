...
<section class="lg:pb-24">
  <div class="max-w-screen-md px-4 mx-auto">
     <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">
        We value every opportunity to connect with you. Whether you have questions, need assistance, or simply want to get in touch, feel free to reach out through the form below. Our team is always here to help and ensure you have the best experience with us.
      </p>
      <p class="mb-4 font-bold text-center text-gray-500 lg:mb-8 dark:text-gray-400 sm:text-xl">
        📞 Atul Singh - +91-8484013747<br>
        📞 Ashish Kumar - +91-7632001357<br>
        📞 Aman Gupta - +91-7892099538
      </p>
      <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">Looking to connect with us? Feel free to reach out through the form below!</p>
      <form name="contact" action="https://formsubmit.co/349e64897bc684e26c35ddae9473c035" method="POST" class="space-y-8">
          <div class="my-4">
